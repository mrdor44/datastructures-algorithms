...
typedef enum {
    ...
    RETURNCODE_HASHTABLE_INSERT_INVALID_PARAMETERS,
    RETURNCODE_HASHTABLE_INSERT_MALLOC_FAILED,
    RETURNCODE_HASHTABLE_REMOVE_INVALID_PARAMETERS,
    RETURNCODE_HASHTABLE_REMOVE_KEY_NOT_FOUND,
    RETURNCODE_HASHTABLE_GET_INVALID_PARAMETERS,
    RETURNCODE_HASHTABLE_GET_KEY_NOT_FOUND,
} t_returncode;
